...
export default function CustomLoginPreview({ settings, screenType }: Props) {
  return (
    <div className="sticky top-6">
      ...
      <div
        ...
        style={{ backgroundColor: screenType === 'basic' ? '#ffffff' : settings.bgColor }}
      >
        ...
        {screenType === 'basic' ? <StaticBasicTypePreview /> : <CustomTypeContent settings={settings} />}
      </div>
    </div>
  );
}
