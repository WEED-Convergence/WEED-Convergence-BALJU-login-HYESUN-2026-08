...
const SCREENS: Screen[] = [
  {
    ...
    href: '/login-custom',
    description:
      '고객사가 자사 브랜드 경험을 폭넓게 구성할 수 있도록 지원하는 확장형 커스텀 타입입니다. 로고, 배너, 서브 타이틀, 로그인 버튼, 자유 블록 등 다양한 영역을 자유롭게 구성할 수 있습니다.',
    customizable: [
      '로고 삽입 영역을 자유롭게 배치할 수 있습니다.',
      '배너 영역의 노출 여부를 선택할 수 있으며, 상단/하단 중 위치를 지정할 수 있습니다. 이미지·이동 URL과 함께 최대 3개까지 등록해 등록 순으로 순차 롤링 노출됩니다.',
      '"My Shop 판매자센터" 등 서브 타이틀 텍스트를 자유롭게 교체할 수 있습니다.',
      '로그인 버튼 색상을 고객사 브랜드 컬러로 변경할 수 있습니다.',
      '배경 색상 또는 이미지를 자유롭게 지정할 수 있습니다.',
      '"블록 추가" 클릭 시 텍스트 블록, 이미지·배너 블록(클릭 시 이동 URL 설정 가능), 링크 버튼 블록(버튼 색상 지정 가능) 중 선택하여 개수 제한 없이 자유 블록을 구성할 수 있습니다.',
    ],
    fixed: [
  ...
  },
  {
    ...
    customizable: [
      ...
      '배너 노출 여부(기본값 사용 안 함)와 상단/하단 위치를 설정할 수 있으며, 배너는 이미지·이동 URL과 함께 최대 3개까지 등록해 등록 순으로 순차 롤링 노출됩니다.',
      '서브타이틀 텍스트를 입력하면 미리보기에 즉시 반영됩니다.',
      '배경 색상을 컬러 피커로 변경하면 미리보기에 즉시 반영됩니다.',
      '"블록 추가"에서 텍스트·이미지·배너·링크 버튼 블록을 개수 제한 없이 추가하거나 삭제할 수 있으며(이미지·배너 블록은 클릭 시 이동 URL도 설정 가능), 추가한 순서대로 미리보기 하단에 반영됩니다.',
