...
const SCREENS: Screen[] = [
  ...
  },
  {
    ...
    customizable: [
      '고객사 로고를 이미지 파일로 첨부하면 미리보기에 즉시 반영됩니다.',
      '로그인 버튼 색상을 컬러 피커로 변경하면 미리보기에 즉시 반영됩니다.',
      '배너 노출 여부(기본값 사용 안 함)와 상단/중단/하단 위치를 설정할 수 있으며, 배너는 이미지·이동 URL과 함께 최대 3개까지 등록해 등록 순으로 순차 롤링 노출됩니다.',
    ...
    fixed: [
      '상단 GNB의 HOME 외 메뉴(환경설정·상품관리·파트너·주문관리·매출관리·정산)는 시각적으로만 존재하며 클릭 동작이 없습니다.',
      '좌측 LNB의 홈·매뉴얼·판매사 메인 등록·배너 관리 메뉴는 클릭 동작이 없습니다.',
      '미리보기의 로고 스택, 아이디·비밀번호 입력 로직 등은 고정값으로 이 화면에서 변경할 수 없습니다.',
      '미리보기에서는 판매사/관리자 탭, 추천 상품 노출 영역, 푸터 정보가 노출되지 않습니다.',
      '상단 탭에서 "기본 타입"을 클릭하면 "기본 타입 관리자" 화면으로 이동합니다.',
    ],
  },
];
